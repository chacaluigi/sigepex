...
import { deleteConcepto } from '../../../features/pagos/conceptosPagoSlice';
        ...
        <>
            ...
            >
                ...
                <AlertDialogContent py={6} _dark={{ bg: "primary.1000"}} borderRadius="2xl">
                    ...
                    <AlertDialogHeader textAlign="center" fontSize="3xl" fontWeight="bold">¿Está seguro de eliminar? </AlertDialogHeader>
