...
import { updateConcepto } from '../../../features/pagos/conceptosPagoSlice';

const ModalEditarConceptoPago = ({ row }) => {
    ...
    const handleUpdate = () => {
        dispatch(updateConcepto(indice));
        setIsModalOpen(false)
    }
            ...
            <Modal isOpen={isModalOpen} onClose={handleModalClose} size="4xl" isCentered>
                <ModalOverlay/>
                    <ModalContent _dark={{ bg: "primary.900" }} borderRadius="none">
                        <ModalHeader textAlign="center">ACTUALIZAR CONCEPTO</ModalHeader>
                        <ModalCloseButton />
                        <ModalBody>
...
export default ModalEditarConceptoPago